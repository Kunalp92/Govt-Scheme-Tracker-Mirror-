...
// Query to fetch data from the "user_table"
$sqlUser1 = "SELECT * FROM govt_scheme_table WHERE status = 'Inactive'";
$resultUser1 = $conn->query($sqlUser1);

// Query to fetch data in descending order based on the unique identifier
$sqlUser1 = "SELECT * FROM govt_scheme_table ORDER BY id DESC";
$result = $conn->query($sqlUser1);
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <div class="col-md-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Active Schemes </h4>
                    ...
                    <div class="col-md-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Completed Schemes </h4>
                                ...
                                <div class="table-responsive" style="height: 500px; overflow: auto;">
                                    ...
                                    <table id="example" class="display expandable-table" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            if ($resultUser1 === false) {
                                                echo "Error: " . $sql . "<br>" . $conn->error;
                                            } elseif ($resultUser1->num_rows > 0) {
                                                // Output data of each row
                                                while ($row = $resultUser1->fetch_assoc()) {
                                                    echo "<tr>";

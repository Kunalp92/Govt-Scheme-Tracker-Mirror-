...
<body onload="startTime()">
        ...
        <ul class="navbar-nav mr-lg-2">
          <li class="nav-item nav-search d-none d-lg-block">
            <div class="input-group">
              ...
              <input type="text" class="form-control" id="navbar-search-input" placeholder="Search Villager"
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="Nagpur-scheme-beneficiary.php">Schemes Beneficiary</a>
                </li>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form id="searchForm" class="search-bar ps-3" method="post">
                    ...
                    <!-- <input type="text" class="form-control" id="search" name="search" placeholder="Search Village Name"
                      required> -->


                    <select class="js-example-basic-single w-100 form-control" id="search" name="search" required>
                      <option value=""></option>
                      <option value="Bhilgaon">Bhilgaon</option>
                      <option value="Mhasala">Mhasala</option>
                      <option value="Khairi">Khairi</option>
                      <option value="Kawtha">Kawtha</option>
                      <option value="Waregaon">Waregaon</option>
                      <option value="Bidbina">Bidbina</option>
                      <option value="Khasala">Khasala</option>
                      <option value="Beena">Beena</option>
                      <option value="Suradevi">Suradevi</option>
                      <option value="Panjra">Panjra</option>
                      <option value="Mahadula">Mahadula</option>
                    ...
                    <button type="button" class="btn btn-outline-secondary btn-fw" onclick="clearSearch()">Show
                      All</button>
                    <button type="button" class="btn btn-outline-success btn-fw" id="downloadBtn">Download Data</button>
                          ...
                          <table id="example" class="display expandable-table" style="width:100%">
                            ...
                            <tbody>
                              ...
                              if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                $search = $_POST["search"];
                                $sqlUser = "SELECT * FROM nagpur_user_table WHERE village LIKE '%$search%'";
                                $resultUser = $conn->query($sqlUser);
                              }
  ...
  <script>
    document.getElementById("downloadBtn").addEventListener("click", function () {
      ...
      link.href = url;
      link.setAttribute("download", "total_villages_data.csv");

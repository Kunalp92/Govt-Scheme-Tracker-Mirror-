...
<body onload="startTime()">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <p class="card-title">Scheme Beneficiary</p>
                                                    ...
                                                    <table id="example" class="display expandable-table"
                                                        ...
                                                        <tbody>
                                                            ...
                                                            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                                                $search = $_POST["search"];
                                                                // Modified SQL query to search across multiple columns for the selected scheme name
                                                                $sqlUser = "SELECT * FROM nagpur_user_table WHERE schemesName LIKE '%$search%' OR schemesName1 LIKE '%$search%' OR schemesName2 LIKE '%$search%'";
                                                                $resultUser = $conn->query($sqlUser);
                                                            }
    ...
    <script>
        document.getElementById("downloadBtn").addEventListener("click", function () {
            ...
            link.href = url;
            link.setAttribute("download", "beneficiary_villages_data.csv");

        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="allVillagers.php">Total Villagers</a></li>
                <li class="nav-item"><a class="nav-link" href="allVillagers-future.php">Future Beneficiary</a></li>
                <li class="nav-item"><a class="nav-link" href="allVillagers-add-new.php">Add Villagers</a></li>
                <li class="nav-item"><a class="nav-link" href="allVillagers-edit.php">Edit Villagers Info</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form id="searchForm" class="search-bar ps-3" method="post">
                    ...
                    <input type="text" class="form-control" id="search" name="search" pattern="\d{12}"
                      placeholder="Search Aadhar Number" required>
